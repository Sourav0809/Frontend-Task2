...
const Footer = () => {
  return (
    <div className=" mt-36 bg-yellow-300 border-t-2 font-custom overflow-hidden border-yellow-300 py-10 px-5 gap-4 flex flex-col md:flex-row justify-around items-center ">
