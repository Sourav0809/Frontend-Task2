          ...
          >
            ...
            <div className="  mt-14 w-full md:px-10 xl:px-14 flex flex-col min-[650px]:flex-row gap-10">
              <div className=" flex flex-col gap-2 justify-center items-center ">
                <h1 className=" text-2xl font-bold font-custom">MailMingle</h1>
              ...
              <div className=" font-roboto flex flex-col justify-start items-start">
                ...
                <p>
                  User Authentication by using google firebase, User can send
                  email & receive email and also can delete email, user
                  specific, profile page, realtime update without refresh the
                  page.
                </p>
